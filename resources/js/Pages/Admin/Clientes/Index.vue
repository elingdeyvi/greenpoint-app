...
const submit = () => {
    ...
    if (isEdit.value) {
        form.transform((data) => ({
            ...
            _method: 'put',
        })).post(route('admin.clientes.update', editing.value.id), options);
    } else {
        form.transform((data) => ({
            ...data,
            activo: data.activo ? 1 : 0,
...
const confirmDelete = () => {
    ...
    router.delete(route('admin.clientes.destroy', deleting.value.id), {
        preserveScroll: true,
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        >
            <form id="cliente-form" @submit.prevent="submit">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div v-if="previewUrl || editing?.logo" class="mt-2">
                        <img
                            :src="previewUrl || `/storage/${editing.logo}`"
                            alt="Vista previa"
                            class="img-thumbnail"
                ...
                <div class="form-check">
                    <input id="cliente-activo" v-model="form.activo" class="form-check-input" type="checkbox" />
        ...
        <ConfirmDeleteModal
            ...
            :message="`¿Eliminar el cliente «${deleting?.nombre ?? ''}»?`"
