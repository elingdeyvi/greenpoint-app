...
export default new createStore({
    state: {
        ...
        menu_style: "vertical",
        layout_style: "full",
        // Perfil de interfaz según sucursal configurada en Configuración de la empresa
        // perfilInterfaz: 'VENTA' | 'VENTA_ALMACEN' | null
        perfilInterfaz: null,
        sucursalTipo: null,
        countryList: [
    ...
    mutations: {
        ...
        setSucursalPerfil(state, payload) {
            state.sucursalTipo = payload?.tipo || null;
            state.perfilInterfaz = payload?.perfil || null;
        },
    },
    getters: {
        layout(state) {
        ...
        perfilInterfaz(state) {
            return state.perfilInterfaz;
        },
    },
    actions: {},
    modules: {},
